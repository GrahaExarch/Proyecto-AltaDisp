...
class ReporterStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.WeatherReport = channel.unary_unary(
                '/weather.Reporter/WeatherReport',
...
def add_ReporterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'WeatherReport': grpc.unary_unary_rpc_method_handler(
                    servicer.WeatherReport,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'weather.Reporter', rpc_method_handlers)
...
class Reporter(object):
    ...
    def WeatherReport(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/weather.Reporter/WeatherReport',
